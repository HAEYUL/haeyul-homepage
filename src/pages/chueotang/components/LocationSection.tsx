const address = '경기 용인시 수지구 고기로 129번길 12';
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="text-sm md:text-base text-foreground-800">031-265-3651</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-base text-foreground-800">
                    10:00 — 20:50 (브레이크타임 없음)
                    <br />
                    <span className="text-foreground-500 text-sm">라스트오더 20:15</span>
                    <br />
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-base text-foreground-800">전용주차장 이용 가능 (70대)</p>
                </div>
              </div>
            </div>
